...
- **Staff account creation flow** — owner-direct or invitation-based. The authority itself is already settled as Admin-only; only the flow remains open, which is why this sits here rather than under the business-authority mechanism below.
