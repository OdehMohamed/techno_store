                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                width: Utilities.getDeviceWidth(context) * 0.5,
                                height:
                                    Utilities.getDeviceHeight(context) * 0.05,
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (_edit_delete_fields_key.currentState!
                                            .validate() &&
                                        _drop_down_list_key.currentState!
                                            .validate()) {
                              ...
                              Container(
                                  margin: EdgeInsets.only(top: 10, bottom: 10),
                                  width:
                                      Utilities.getDeviceWidth(context) * 0.5,
                                  height:
                                      Utilities.getDeviceHeight(context) * 0.05,
                                  child: ElevatedButton(
                                    onPressed: () {
                                      if (sub_category_flag) {
                                        if (_drop_down_list_key.currentState!
                                            .validate()) {
                                          manageCategoriesState
                                              .deleteSubCategory(
                                                  selectedCategory!.id!,
                                    ...
                                    child:
                                        WidgetUtilities.autoSizeText("Delete"),
                                    style: ElevatedButton.styleFrom(
